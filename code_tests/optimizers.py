...
class Optimizer(object):
  ...
  def get_gradients(self, loss, params):
    ...
    """
    grads = K.gradients(loss, params) # gibt Tensor mit Gradienten von loss ausgewertet in params
    ...
    return grads # Tensor mit Gradienten
  ...
  def set_weights(self, weights):
    ...
    weight_value_tuples = []
    param_values = K.batch_get_value(params) # Returns the value of more than one tensor variable.
  ...
  def get_weights(self):
    ...
    """
    return K.batch_get_value(self.weights) # Returns the value of more than one tensor variable.
...
class SGD(Optimizer):
  ...
  def __init__(self, lr=0.01, momentum=0., decay=0., nesterov=False, **kwargs):
    super(SGD, self).__init__(**kwargs) # für alle Optimizer gleich, SGD vom Namen der Klasse
  ...
  def get_config(self):      # das immer auf diese Art
    ...
    base_config = super(SGD, self).get_config()     # das immer
